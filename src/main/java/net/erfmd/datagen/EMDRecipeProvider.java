...
public class EMDRecipeProvider extends FabricRecipeProvider {
    ...
    public EMDRecipeProvider(FabricDataOutput output) {
        super(output);
    }
    ...
    public void generate(RecipeExporter exporter) {
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, EMDBlocks.POLISHED_STONE, 4)
                .pattern("SS")
                .pattern("SS")
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, EMDBlocks.POLISHED_STONE_PILLAR)
                .pattern("S")
                .pattern("S")
                .input('S', EMDBlocks.POLISHED_STONE)
                .criterion(hasItem(EMDBlocks.POLISHED_STONE), conditionsFromItem(EMDBlocks.POLISHED_STONE))
                .offerTo(exporter, new Identifier(getRecipeName(EMDBlocks.POLISHED_STONE_PILLAR)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, EMDBlocks.TERRACOTTA_BRICKS, 4)
                .pattern("SS")
                .pattern("SS")
                .input('S', Blocks.TERRACOTTA)
                .criterion(hasItem(Blocks.TERRACOTTA), conditionsFromItem(Blocks.TERRACOTTA))
                .offerTo(exporter, new Identifier(getRecipeName(EMDBlocks.TERRACOTTA_BRICKS)));
        ShapedRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, EMDBlocks.WHITE_TERRACOTTA_BRICKS, 4)
                .pattern("SS")
                .pattern("SS")
                .input('S', Blocks.WHITE_TERRACOTTA)
                .criterion(hasItem(Blocks.WHITE_TERRACOTTA), conditionsFromItem(Blocks.WHITE_TERRACOTTA))
                .offerTo(exporter, new Identifier(getRecipeName(EMDBlocks.WHITE_TERRACOTTA_BRICKS)));
        ShapedRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, EMDBlocks.LIGHT_GRAY_TERRACOTTA_BRICKS, 4)
                .pattern("SS")
                .pattern("SS")
                ...
                .offerTo(exporter, new Identifier(getRecipeName(EMDBlocks.LIGHT_GRAY_TERRACOTTA_BRICKS)));
        ShapedRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, EMDBlocks.GRAY_TERRACOTTA_BRICKS, 4)
                .pattern("SS")
                .pattern("SS")
                .input('S', Blocks.GRAY_TERRACOTTA)
                .criterion(hasItem(Blocks.GRAY_TERRACOTTA), conditionsFromItem(Blocks.GRAY_TERRACOTTA))
                .offerTo(exporter, new Identifier(getRecipeName(EMDBlocks.GRAY_TERRACOTTA_BRICKS)));
        ShapedRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, EMDBlocks.BLACK_TERRACOTTA_BRICKS, 4)
                .pattern("SS")
                .pattern("SS")
                .input('S', Blocks.BLACK_TERRACOTTA)
                .criterion(hasItem(Blocks.BLACK_TERRACOTTA), conditionsFromItem(Blocks.BLACK_TERRACOTTA))
                .offerTo(exporter, new Identifier(getRecipeName(EMDBlocks.BLACK_TERRACOTTA_BRICKS)));
        ShapedRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, EMDBlocks.BROWN_TERRACOTTA_BRICKS, 4)
                .pattern("SS")
                .pattern("SS")
                .input('S', Blocks.BROWN_TERRACOTTA)
                .criterion(hasItem(Blocks.BROWN_TERRACOTTA), conditionsFromItem(Blocks.BROWN_TERRACOTTA))
                .offerTo(exporter, new Identifier(getRecipeName(EMDBlocks.BROWN_TERRACOTTA_BRICKS)));
        ShapedRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, EMDBlocks.RED_TERRACOTTA_BRICKS, 4)
                .pattern("SS")
                .pattern("SS")
                .input('S', Blocks.RED_TERRACOTTA)
                .criterion(hasItem(Blocks.RED_TERRACOTTA), conditionsFromItem(Blocks.RED_TERRACOTTA))
                .offerTo(exporter, new Identifier(getRecipeName(EMDBlocks.RED_TERRACOTTA_BRICKS)));
        ShapedRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, EMDBlocks.ORANGE_TERRACOTTA_BRICKS, 4)
                .pattern("SS")
                .pattern("SS")
                .input('S', Blocks.ORANGE_TERRACOTTA)
                .criterion(hasItem(Blocks.ORANGE_TERRACOTTA), conditionsFromItem(Blocks.ORANGE_TERRACOTTA))
                .offerTo(exporter, new Identifier(getRecipeName(EMDBlocks.ORANGE_TERRACOTTA_BRICKS)));
        ShapedRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, EMDBlocks.YELLOW_TERRACOTTA_BRICKS, 4)
                .pattern("SS")
                .pattern("SS")
                .input('S', Blocks.YELLOW_TERRACOTTA)
                .criterion(hasItem(Blocks.YELLOW_TERRACOTTA), conditionsFromItem(Blocks.YELLOW_TERRACOTTA))
                .offerTo(exporter, new Identifier(getRecipeName(EMDBlocks.YELLOW_TERRACOTTA_BRICKS)));
        ShapedRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, EMDBlocks.LIME_TERRACOTTA_BRICKS, 4)
                .pattern("SS")
                .pattern("SS")
                .input('S', Blocks.LIME_TERRACOTTA)
                .criterion(hasItem(Blocks.LIME_TERRACOTTA), conditionsFromItem(Blocks.LIME_TERRACOTTA))
                .offerTo(exporter, new Identifier(getRecipeName(EMDBlocks.LIME_TERRACOTTA_BRICKS)));
        ShapedRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, EMDBlocks.GREEN_TERRACOTTA_BRICKS, 4)
                .pattern("SS")
                .pattern("SS")
                .input('S', Blocks.GREEN_TERRACOTTA)
                .criterion(hasItem(Blocks.GREEN_TERRACOTTA), conditionsFromItem(Blocks.GREEN_TERRACOTTA))
                .offerTo(exporter, new Identifier(getRecipeName(EMDBlocks.GREEN_TERRACOTTA_BRICKS)));
        ShapedRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, EMDBlocks.CYAN_TERRACOTTA_BRICKS, 4)
                .pattern("SS")
                .pattern("SS")
                .input('S', Blocks.CYAN_TERRACOTTA)
                .criterion(hasItem(Blocks.CYAN_TERRACOTTA), conditionsFromItem(Blocks.CYAN_TERRACOTTA))
                .offerTo(exporter, new Identifier(getRecipeName(EMDBlocks.CYAN_TERRACOTTA_BRICKS)));
        ShapedRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, EMDBlocks.LIGHT_BLUE_TERRACOTTA_BRICKS, 4)
                .pattern("SS")
                .pattern("SS")
                ...
                .offerTo(exporter, new Identifier(getRecipeName(EMDBlocks.LIGHT_BLUE_TERRACOTTA_BRICKS)));
        ShapedRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, EMDBlocks.BLUE_TERRACOTTA_BRICKS, 4)
                .pattern("SS")
                .pattern("SS")
                .input('S', Blocks.BLUE_TERRACOTTA)
                .criterion(hasItem(Blocks.BLUE_TERRACOTTA), conditionsFromItem(Blocks.BLUE_TERRACOTTA))
                .offerTo(exporter, new Identifier(getRecipeName(EMDBlocks.BLUE_TERRACOTTA_BRICKS)));
        ShapedRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, EMDBlocks.PURPLE_TERRACOTTA_BRICKS, 4)
                .pattern("SS")
                .pattern("SS")
                .input('S', Blocks.PURPLE_TERRACOTTA)
                .criterion(hasItem(Blocks.PURPLE_TERRACOTTA), conditionsFromItem(Blocks.PURPLE_TERRACOTTA))
                .offerTo(exporter, new Identifier(getRecipeName(EMDBlocks.PURPLE_TERRACOTTA_BRICKS)));
        ShapedRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, EMDBlocks.MAGENTA_TERRACOTTA_BRICKS, 4)
                .pattern("SS")
                .pattern("SS")
                ...
                .offerTo(exporter, new Identifier(getRecipeName(EMDBlocks.MAGENTA_TERRACOTTA_BRICKS)));
        ShapedRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, EMDBlocks.PINK_TERRACOTTA_BRICKS, 4)
                .pattern("SS")
                .pattern("SS")
                .input('S', Blocks.PINK_TERRACOTTA)
                .criterion(hasItem(Blocks.PINK_TERRACOTTA), conditionsFromItem(Blocks.PINK_TERRACOTTA))
                .offerTo(exporter, new Identifier(getRecipeName(EMDBlocks.PINK_TERRACOTTA_BRICKS)));



        ShapedRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, EMDBlocks.POLISHED_OBSIDIAN, 4)
                .pattern("SS")
                .pattern("SS")
                .input('S', Blocks.OBSIDIAN)
                .criterion(hasItem(Blocks.OBSIDIAN), conditionsFromItem(Blocks.OBSIDIAN))
                .offerTo(exporter, new Identifier(getRecipeName(EMDBlocks.POLISHED_OBSIDIAN)));
        ShapedRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, EMDBlocks.POLISHED_OBSIDIAN_STAIRS, 4)
                .pattern("S  ")
                .pattern("SS ")
                .pattern("SSS")
                .input('S', EMDBlocks.POLISHED_OBSIDIAN)
                .criterion(hasItem(EMDBlocks.POLISHED_OBSIDIAN), conditionsFromItem(EMDBlocks.POLISHED_OBSIDIAN))
                .offerTo(exporter, new Identifier(getRecipeName(EMDBlocks.POLISHED_OBSIDIAN_STAIRS)));
        ShapedRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, EMDBlocks.POLISHED_OBSIDIAN_SLAB, 6)
                .pattern("SSS")
                .input('S', EMDBlocks.POLISHED_OBSIDIAN)
                .criterion(hasItem(EMDBlocks.POLISHED_OBSIDIAN), conditionsFromItem(EMDBlocks.POLISHED_OBSIDIAN))
                .offerTo(exporter, new Identifier(getRecipeName(EMDBlocks.POLISHED_OBSIDIAN_SLAB)));
        ShapedRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, EMDBlocks.POLISHED_OBSIDIAN_WALL, 6)
                .pattern("SSS")
                .pattern("SSS")
                .input('S', EMDBlocks.POLISHED_OBSIDIAN)
                .criterion(hasItem(EMDBlocks.POLISHED_OBSIDIAN), conditionsFromItem(EMDBlocks.POLISHED_OBSIDIAN))
                .offerTo(exporter, new Identifier(getRecipeName(EMDBlocks.POLISHED_OBSIDIAN_WALL)));

        ShapedRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, EMDBlocks.OBSIDIAN_BRICKS, 4)
                .pattern("SS")
                .pattern("SS")
                .input('S', Blocks.OBSIDIAN)
                .criterion(hasItem(Blocks.OBSIDIAN), conditionsFromItem(Blocks.OBSIDIAN))
                .offerTo(exporter, new Identifier(getRecipeName(EMDBlocks.OBSIDIAN_BRICKS)));
        ShapedRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, EMDBlocks.OBSIDIAN_BRICK_STAIRS, 4)
                .pattern("S  ")
                .pattern("SS ")
                .pattern("SSS")
                .input('S', EMDBlocks.OBSIDIAN_BRICKS)
                .criterion(hasItem(EMDBlocks.OBSIDIAN_BRICKS), conditionsFromItem(EMDBlocks.OBSIDIAN_BRICKS))
                .offerTo(exporter, new Identifier(getRecipeName(EMDBlocks.OBSIDIAN_BRICK_STAIRS)));
        ShapedRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, EMDBlocks.OBSIDIAN_BRICK_SLAB, 6)
                .pattern("SSS")
                .input('S', EMDBlocks.OBSIDIAN_BRICKS)
                .criterion(hasItem(EMDBlocks.OBSIDIAN_BRICKS), conditionsFromItem(EMDBlocks.OBSIDIAN_BRICKS))
                .offerTo(exporter, new Identifier(getRecipeName(EMDBlocks.OBSIDIAN_BRICK_SLAB)));
        ShapedRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, EMDBlocks.OBSIDIAN_BRICK_WALL, 6)
                .pattern("SSS")
                .pattern("SSS")
                .input('S', EMDBlocks.OBSIDIAN_BRICKS)
                .criterion(hasItem(EMDBlocks.OBSIDIAN_BRICKS), conditionsFromItem(EMDBlocks.OBSIDIAN_BRICKS))
                .offerTo(exporter, new Identifier(getRecipeName(EMDBlocks.OBSIDIAN_BRICK_WALL)));

        ShapedRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, EMDBlocks.CHISELED_OBSIDIAN)
                .pattern("S")
                .pattern("S")
                .input('S', EMDBlocks.POLISHED_OBSIDIAN_SLAB)
                .criterion(hasItem(EMDBlocks.POLISHED_OBSIDIAN_SLAB), conditionsFromItem(EMDBlocks.POLISHED_OBSIDIAN_SLAB))
                .offerTo(exporter, new Identifier(getRecipeName(EMDBlocks.CHISELED_OBSIDIAN)));

        ShapedRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, EMDBlocks.OBSIDIAN_PILLAR)
                .pattern("S")
                .pattern("S")
                .input('S', EMDBlocks.POLISHED_OBSIDIAN)
                .criterion(hasItem(EMDBlocks.POLISHED_OBSIDIAN), conditionsFromItem(EMDBlocks.POLISHED_OBSIDIAN))
                .offerTo(exporter, new Identifier(getRecipeName(EMDBlocks.OBSIDIAN_PILLAR)));
        ...
        RecipeProvider.offerStonecuttingRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, EMDBlocks.POLISHED_STONE_PILLAR, Blocks.STONE);
        ...
        RecipeProvider.offerStonecuttingRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, EMDBlocks.POLISHED_STONE_PILLAR, EMDBlocks.POLISHED_STONE);
        ...
        RecipeProvider.offerStonecuttingRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, EMDBlocks.TERRACOTTA_BRICKS, Blocks.TERRACOTTA);
        RecipeProvider.offerStonecuttingRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, EMDBlocks.WHITE_TERRACOTTA_BRICKS, Blocks.WHITE_TERRACOTTA);
        RecipeProvider.offerStonecuttingRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, EMDBlocks.LIGHT_GRAY_TERRACOTTA_BRICKS, Blocks.LIGHT_GRAY_TERRACOTTA);
        RecipeProvider.offerStonecuttingRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, EMDBlocks.GRAY_TERRACOTTA_BRICKS, Blocks.GRAY_TERRACOTTA);
        RecipeProvider.offerStonecuttingRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, EMDBlocks.BLACK_TERRACOTTA_BRICKS, Blocks.BLACK_TERRACOTTA);
        RecipeProvider.offerStonecuttingRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, EMDBlocks.BROWN_TERRACOTTA_BRICKS, Blocks.BROWN_TERRACOTTA);
        RecipeProvider.offerStonecuttingRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, EMDBlocks.RED_TERRACOTTA_BRICKS, Blocks.RED_TERRACOTTA);
        RecipeProvider.offerStonecuttingRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, EMDBlocks.ORANGE_TERRACOTTA_BRICKS, Blocks.ORANGE_TERRACOTTA);
        RecipeProvider.offerStonecuttingRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, EMDBlocks.YELLOW_TERRACOTTA_BRICKS, Blocks.YELLOW_TERRACOTTA);
        RecipeProvider.offerStonecuttingRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, EMDBlocks.LIME_TERRACOTTA_BRICKS, Blocks.LIME_TERRACOTTA);
        RecipeProvider.offerStonecuttingRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, EMDBlocks.GREEN_TERRACOTTA_BRICKS, Blocks.GREEN_TERRACOTTA);
        RecipeProvider.offerStonecuttingRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, EMDBlocks.CYAN_TERRACOTTA_BRICKS, Blocks.CYAN_TERRACOTTA);
        RecipeProvider.offerStonecuttingRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, EMDBlocks.LIGHT_BLUE_TERRACOTTA_BRICKS, Blocks.LIGHT_BLUE_TERRACOTTA);
        RecipeProvider.offerStonecuttingRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, EMDBlocks.BLUE_TERRACOTTA_BRICKS, Blocks.BLUE_TERRACOTTA);
        RecipeProvider.offerStonecuttingRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, EMDBlocks.PURPLE_TERRACOTTA_BRICKS, Blocks.PURPLE_TERRACOTTA);
        RecipeProvider.offerStonecuttingRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, EMDBlocks.MAGENTA_TERRACOTTA_BRICKS, Blocks.MAGENTA_TERRACOTTA);
        RecipeProvider.offerStonecuttingRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, EMDBlocks.PINK_TERRACOTTA_BRICKS, Blocks.PINK_TERRACOTTA);



        RecipeProvider.offerStonecuttingRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, EMDBlocks.POLISHED_OBSIDIAN, Blocks.OBSIDIAN);
        RecipeProvider.offerStonecuttingRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, EMDBlocks.POLISHED_OBSIDIAN_SLAB, Blocks.OBSIDIAN, 2);
        RecipeProvider.offerStonecuttingRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, EMDBlocks.POLISHED_OBSIDIAN_STAIRS, Blocks.OBSIDIAN);
        RecipeProvider.offerStonecuttingRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, EMDBlocks.POLISHED_OBSIDIAN_WALL, Blocks.OBSIDIAN);
        RecipeProvider.offerStonecuttingRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, EMDBlocks.OBSIDIAN_BRICKS, Blocks.OBSIDIAN);
        RecipeProvider.offerStonecuttingRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, EMDBlocks.OBSIDIAN_BRICK_SLAB, Blocks.OBSIDIAN, 2);
        RecipeProvider.offerStonecuttingRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, EMDBlocks.OBSIDIAN_BRICK_STAIRS, Blocks.OBSIDIAN);
        RecipeProvider.offerStonecuttingRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, EMDBlocks.OBSIDIAN_BRICK_WALL, Blocks.OBSIDIAN);
        RecipeProvider.offerStonecuttingRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, EMDBlocks.CHISELED_OBSIDIAN, Blocks.OBSIDIAN);
        RecipeProvider.offerStonecuttingRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, EMDBlocks.OBSIDIAN_PILLAR, Blocks.OBSIDIAN);
        RecipeProvider.offerStonecuttingRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, EMDBlocks.POLISHED_OBSIDIAN_SLAB, EMDBlocks.POLISHED_OBSIDIAN, 2);
        RecipeProvider.offerStonecuttingRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, EMDBlocks.POLISHED_OBSIDIAN_STAIRS, EMDBlocks.POLISHED_OBSIDIAN);
        RecipeProvider.offerStonecuttingRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, EMDBlocks.POLISHED_OBSIDIAN_WALL, EMDBlocks.POLISHED_OBSIDIAN);
        RecipeProvider.offerStonecuttingRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, EMDBlocks.OBSIDIAN_BRICKS, EMDBlocks.POLISHED_OBSIDIAN);
        RecipeProvider.offerStonecuttingRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, EMDBlocks.OBSIDIAN_BRICK_SLAB, EMDBlocks.POLISHED_OBSIDIAN, 2);
        RecipeProvider.offerStonecuttingRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, EMDBlocks.OBSIDIAN_BRICK_STAIRS, EMDBlocks.POLISHED_OBSIDIAN);
        RecipeProvider.offerStonecuttingRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, EMDBlocks.OBSIDIAN_BRICK_WALL, EMDBlocks.POLISHED_OBSIDIAN);
        RecipeProvider.offerStonecuttingRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, EMDBlocks.CHISELED_OBSIDIAN, EMDBlocks.POLISHED_OBSIDIAN);
        RecipeProvider.offerStonecuttingRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, EMDBlocks.OBSIDIAN_PILLAR, EMDBlocks.POLISHED_OBSIDIAN);
        RecipeProvider.offerStonecuttingRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, EMDBlocks.OBSIDIAN_BRICK_SLAB, EMDBlocks.OBSIDIAN_BRICKS, 2);
        RecipeProvider.offerStonecuttingRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, EMDBlocks.OBSIDIAN_BRICK_STAIRS, EMDBlocks.OBSIDIAN_BRICKS);
        RecipeProvider.offerStonecuttingRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, EMDBlocks.OBSIDIAN_BRICK_WALL, EMDBlocks.OBSIDIAN_BRICKS);

...
public class EMDFoodComponents {
    public static final FoodComponent PIECE_OF_CAKE = new FoodComponent.Builder().hunger(2).saturationModifier(0.1f).build();
    public static final FoodComponent PIECE_OF_CHOCOLATE_CAKE = new FoodComponent.Builder().hunger(3)
            .saturationModifier(0.25f).build();
    public static final FoodComponent PIECE_OF_EXPERIMENT_115 = new FoodComponent.Builder().hunger(2).saturationModifier(0.5f)
    ...
    public static final FoodComponent PIECE_OF_EXPERIMENT_803S = new FoodComponent.Builder()
            ...
            .build();
    public static final FoodComponent ROSE_GOLDEN_APPLE = new FoodComponent.Builder().hunger(5).saturationModifier(1.2f)
            .statusEffect(new StatusEffectInstance(StatusEffects.ABSORPTION, 2400), 1.0f)
    ...
    public static final FoodComponent CARAMEL = new FoodComponent.Builder().hunger(4).saturationModifier(0.4f).build();
    public static final FoodComponent CARAMEL_APPLE = new FoodComponent.Builder().hunger(6).saturationModifier(1.0f).build();

    public static final FoodComponent MEAT_CLUB = new FoodComponent.Builder().hunger(8).saturationModifier(0.8f).build();
    public static final FoodComponent LOLLICHOP = new FoodComponent.Builder().hunger(5).saturationModifier(0.6f).build();
    public static final FoodComponent CANDY_CANE = new FoodComponent.Builder().hunger(5).saturationModifier(0.8f).build();
    public static final FoodComponent WORKER_DRONE_ARM = new FoodComponent.Builder().hunger(6).saturationModifier(0.6f).build();
    ...
    public static final FoodComponent HONEYSUCKLE = new FoodComponent.Builder().hunger(3).saturationModifier(0.5f).build();
    public static final FoodComponent CHERRY_PIE = new FoodComponent.Builder().hunger(8).saturationModifier(0.6f).build();
    public static final FoodComponent HONEYSUCKLE_PIE = new FoodComponent.Builder().hunger(8).saturationModifier(0.8f).build();
}
